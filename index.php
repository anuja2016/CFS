...
<section class="feature-section">
  <div class="container-fluid">
    <div class="text-center mt-5 mb-3">
      ...
      <p class="title">Simplify Your <span class="drawn-underline">Service Business</span> Operations</p>
    </div>
    <div class="row m-4">
      <div class="col-md-3 col-sm-12 text-center">
        <img src="assets/images/createsquotus.svg" />
        <p class="title-lg-mont mt-2 mb-2">Create Quotes</p>
        <p class="pt-1 title-sm-mont">Generate accurate quotes instantly, tailored to client needs. Simplify the quoting
      ...
      <div class="col-md-3 col-sm-12 text-center ">
        ...
        <p class="title-lg-mont mt-2 mb-2">Intelligent Scheduling</p>
        <p class="pt-1 title-sm-mont">Effortlessly Schedule task to your Field worker with respect to their work
          speciality, allocated work
          area, time availability and nearest location.</p>
      </div>
      <div class="col-md-3 col-sm-12 text-center">
        <img src="assets/images/smartdispatching.svg" />
        <p class="title-lg-mont mt-2 mb-2">Smart Dispatching</p>
        <p class="pt-1 title-sm-mont">Utilize cutting-edge technology to efficiently track your workforce, ensuring
          automatic assignment of the most suitable technician to each job.
        </p>
      </div>
      <div class="col-md-3 col-sm-12 text-center">
        <img src="assets/images/effertlessicon.svg" />
        <p class="title-lg-mont mt-2 mb-2">Effortless Invoicing</p>
        <p class="pt-1 title-sm-mont">Streamline invoicing process with just one click. Enjoy digital invoicing,
...
<section>
  <div class="container-fluid mb-3">
    <div class="text-center mt-5 mb-3">
      ...
      <p class="title drawn-underline">Home Service Business</p>
    </div>
...
<section>
  <div class="container-fluid">
    <div class="text-center mt-5 mb-3">
      ...
      <p class="title drawn-underline">Served by FieldWeb</p>
    </div>
