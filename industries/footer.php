  ...
  <div class="main-Wrapper">
    <div class="row">
      ...
      <div class="col-md-2 col-sm-4 col-6">
        <h4>Industries</h4>
        <ul class="footer-menu">
          <li><a href="hvac-service-software.php">HVAC </a></li>
          <li><a href="plumbing-service-software.php">Plumbing </a></li>
          <li><a href="garage-door_installation-service-software.php">Garage door</a></li>
          <li><a href="electrical-service-software.php">Electrical contractor </a></li>
          <li><a href="home-appliance-service-software.php">Appliance Repair</a></li>
          <li><a href="carpet-cleaning-service-software.php">Carpet Cleaning</a></li>
          <li><a href="landscaping-lawn-service-software.php">Landscaping and lawa </a></li>
          <li><a href="pest-control-service-software.php">Pest Control </a></li>
          <li><a href="home-clean-service-software.pho">Home Cleaning </a></li>
