...
<section class="banner-block-lft mt-116 margin-btm">
    <div class="block-img">
        <img src="../assets/images/banners/feature_banner_quote.jpg" class="img-fluid desk-homebanner" alt="features-banner">
...
<section class="main-Wrapper margin-btm" data-aos="fade-up">
    <div class="mb-3 text-center">
        <h3 class="title-md-montbold">FieldWeb ensures your seamless organization at every job phase.</h3>
    </div>
    ...
    <div class="main-Wrapper">
        ...
        <div class="margin-btm" id="tb-createquote">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-6">
                    <img src="../assets/images/features/create_quotation.jpg" class="img-fluid">
                </div>
                <div class="col-md-6">
        ...
        <div class="margin-btm" id="tb-send-slatc">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="../assets/images/features/attach_sla_and_t&c.jpg" class="img-fluid">
                </div>
                <div class="col-md-6">
        ...
        <div class="margin-btm" id="tb-quoteapproval">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-6">
                    <img src="../assets/images/features/quote_approvals.jpg" class="img-fluid">
                </div>
                <div class="col-md-6">
        ...
        <div class="margin-btm" id="tb-quotestatus">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="../assets/images/features/quote_status.jpg" class="img-fluid">
                </div>
                <div class="col-md-6">
        ...
        <div class="margin-btm" id="tb-createjob">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-6">
                    <img src="../assets/images/features/create_task.jpg" class="img-fluid">
                </div>
                <div class="col-md-6">
...
<section class="main-Wrapper margin-btm" data-aos="fade-up">
    <div class="sect-jobquote text-justify">
        ...
        <ul>
            <li>Key features and benefits of quote management software include:</li>
