    ...
    <div class="row">
      <div class="col-lg-2 col-md-4">
        ...
        <ul class="footer-menu">
          ...
          <li><a href="#" class="d-flex">All Features<span class="ps-2"><img src="assets/images/whitearrow.svg" class="signin-size" /></span></a></li>
        </ul>
      </div>
      <div class="col-lg-2 col-md-4">
        <h4>Industries</h4>
        <ul class="footer-menu">
          ...
          <li><a href="#">All Industries<span class="ps-2"><img src="assets/images/whitearrow.svg" class="signin-size" /></span></a></li>
        </ul>
      </div>
      <div class="col-lg-2 col-md-4">
        <h4>Resource</h4>
        <ul class="footer-menu">
          ...
          <li><a href="#">Working in the trades</a></li>
          <li><a href="#">Mastermind</a></li>
          <li><a href="#">Integration</a></li>
          <li><a href="#">New & Press</a></li>
        </ul>
      </div>
      <div class="col-lg-2 col-md-4">
        <h4>Company</h4>
        <ul class="footer-menu">
          ...
          <li><a href="#">Testimonals and reviews</a></li>
      ...
      <div class="col-lg-4 col-md-4 ps-4">
        ...
        <div>
          ...
          <ul class="store-links">
            <li><a href="https://www.apple.com/in/app-store/" target="_blank"><img src="assets/images/appstorelogo.svg" class="ps-2" /></a></li>
