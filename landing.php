        ...
        <div class="block-white-border">
            <div class="row p-4">
                <div class="col-md-6">
                    ...
                    <p>Gravida donec integer ipsum porta justo at odio velna vitae auctor integer magna at risus auctor purus rutrum primis ultrice ligula luctus</p>
                </div>
                <div class="col-md-6">
...
<section class="sect-landingapp margin-btm">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-5 col-sm-6" data-aos="fade-left" data-aos-duration="1500">
                ...
                <ul class="appfeatures-list">
                    <li>
                        <img src="assets/images/redcircularred.svg" class="icon-sm-img" />
                ...
                <div class="mt-4 mb-3">
                    <a href="#" type="button" class="btn-bright-red">GET DEMO</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="margin-btm">
    <div class="text-center mb-5">
        ...
        <p class="title-md w-50 m-auto">Aliquam a augue suscipit, luctus neque purus ipsum neque dolor primis libero tempus, tempor posuere ligula varius</p>
    </div>
    <div class="container">
        <div class="our-stories-slider mt-2 mb-8">
            <div class="card m-2">
                <img src="assets/images/storiesimg1.svg" class="card-img-top">
                <div class="card-body">
                    <label>November 4, 2018 in Illustration</label>
                    <h6 class="mt-2">Turpis quaerat ipsam egestas volute sapien vitae</h6>
                ...
                <div class="d-flex justify-content-md-end flex-row gap-5 mt-2">
                    ...
                    <div class="d-flex gap-1 align-items-center">
                        <img src="assets/images/commentimg.svg">
                        <span>3</span>
                    </div>
            ...
            <div class="card m-2">
                <img src="assets/images/storiesimg2.svg" class="card-img-top">
                <div class="card-body">
                    <label>November 4, 2018 in Illustration</label>
                    <h6 class="mt-2">Turpis quaerat ipsam egestas volute sapien vitae</h6>
                    <p>Aliqum mullam blandit tempor sapien gravida donec ipsum, at porta justo. Velna vitae auctor congue magna nihil impedit</p>
            ...
            <div class="card m-2">
                <img src="assets/images/storiesimg3.svg" class="card-img-top">
                <div class="card-body">
                    <label>November 4, 2018 in Illustration</label>
                    <h6 class="mt-2">Turpis quaerat ipsam egestas volute sapien vitae</h6>
                    <p>Aliqum mullam blandit tempor sapien gravida donec ipsum, at porta justo. Velna vitae auctor congue magna nihil impedit</p>
            ...
            <div class="card m-2">
                ...
                <div class="d-flex justify-content-md-end flex-row gap-5 mt-2">
                    ...
                    <div class="d-flex gap-1 align-items-center">
                        <img src="assets/images/commentimg.svg" class="icon-sm-img">
                        <p class="stories-footer-para">3</p>
                    </div>
                    <a href="#">More Details</a>
                </div>
            </div>
