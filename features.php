    ...
    <div class="main-Wrapper">
        <ul class="nav nav-pills justify-content-center mb-3">
            <div class="d-flex gap-4">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#tb-frontoffice">Front Office</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tb-fieldoperation">Field Operation</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tb-customerexperience">Customer Experience</a>
                </li>
            </div>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade show active" id="tb-frontoffice">
                <div class="mt-5">
            ...
            <div class="tab-pane fade" id="tb-fieldoperation">
                <div class="mt-5">
                    <div class="text-center">
            ...
            <div class="tab-pane fade" id="tb-customerexperience">
                <div class="mt-5">
                    <div class="text-center">
